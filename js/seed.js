...
const PLAN_A = {
  ...
  exercises: [
    {
      id: "a1", name: "Dřep s osou na zádech", mode: "reps", sets: 3, repsMin: 8, repsMax: 10, weightKg: 20,
      note: "dlouhá osa",
    ...
    {
      id: "a2", name: "Bench press na lavici", mode: "reps", sets: 3, repsMin: 8, repsMax: 10, weightKg: 20,
      note: "dlouhá osa",
    ...
    {
      id: "a3", name: "Přítahy na hrazdě podhmatem", mode: "amrap", sets: 3, repsMin: null, repsMax: null, weightKg: null,
    ...
    {
      id: "a4", name: "Tlaky na ramena vsedě", mode: "reps", sets: 3, repsMin: 8, repsMax: 10, weightKg: 10,
    ...
    {
      id: "a5", name: "Bradla", mode: "amrap", sets: 3, repsMin: null, repsMax: null, weightKg: null,
    ...
    {
      id: "a6", name: "Plank", mode: "time", sets: 3, repsMin: 30, repsMax: 45, weightKg: null,
      note: "",
...
const PLAN_B = {
  ...
  exercises: [
    {
      id: "b1", name: "Rumunský mrtvý tah", mode: "reps", sets: 3, repsMin: 8, repsMax: 10, weightKg: 30,
      note: "dlouhá osa",
    ...
    {
      id: "b2", name: "Přítahy jednoručky v předklonu", mode: "reps", sets: 3, repsMin: 10, repsMax: 12, weightKg: 12.5,
    ...
    {
      id: "b3", name: "Shyby na hrazdě", mode: "amrap", sets: 3, repsMin: null, repsMax: null, weightKg: null,
    ...
    {
      id: "b4", name: "Bulharské dřepy", mode: "reps", sets: 3, repsMin: 8, repsMax: 10, weightKg: 10,
    ...
    {
      id: "b5", name: "Bicepsový zdvih s krátkou osou", mode: "reps", sets: 3, repsMin: 10, repsMax: 12, weightKg: 10,
      note: "",
    ...
    {
      id: "b6", name: "Zvedání nohou ve visu", mode: "reps", sets: 3, repsMin: 10, repsMax: 15, weightKg: null,
